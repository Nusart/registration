...
<html lang="en">
    ...
    <body>
        ...
        <form action="delete.php" method="post">
            <label for="exampleFormControlSelect1">Enter the <strong>Roll No</strong> whose data you want to <strong>delete.</strong></label>
            <div class="form-group">
                <div class="row">
                    <div class="col-lg-3">
                        <br/><input type="text" class="form-control" id="formGroupExampleInput" placeholder="Roll No" name="roll">
            ...
            <br/><button type="submit" class="btn btn-secondary">Delete</button>
        </form>
        <div class="footer">
          <div class="row">
              <div class="col-lg-9">
